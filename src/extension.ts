...
export async function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(
        ...
        vscode.commands.registerCommand('jarvis.generateProject', () => generateProjectCommand.execute()),
        ...
        vscode.commands.registerCommand('jarvis.viewConversationHistory', () => viewConversationHistoryCommand.execute()),
        statusBar
    );
    ...
    if (!hasShownWelcome) {
        vscode.window.showInformationMessage('Welcome to Jarvis AI Assistant! Press Ctrl+Shift+J (Cmd+Shift+J on Mac) to ask me a question.');
